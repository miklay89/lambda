...
exports.calcDeadline = exports.calcTime = exports.calcPrice = void 0;
const priceRuUa = 0.05;
const priceEng = 0.12;
// UTC hours +0
const startingHour = 8;
const endingHour = 17;
function calcPrice(language, mimetype, count) {
    let totalPrice = 0;
    switch (true) {
        case language == "ru":
        case language == "ua":
...
function calcTime(language, mimetype, count) {
    let totalTime = 0;
    switch (true) {
        case language == "ru":
        case language == "ua":
...
function isWorkingHours(date) {
    ...
    if (curHour >= startingHour && curHour < endingHour)
        return true;
    return false;
}
...
function calcDeadline(timeForWorkInMS, dateNow) {
