...
// search by address in clinic table - ilike (to search lowercase strings)
const searchByClinicAddress: RequestHandler = async (req, res) => {
  try {
    const clinicAddress = `%${req.params.address.toLocaleLowerCase()}%`;
...
export default searchByClinicAddress;
